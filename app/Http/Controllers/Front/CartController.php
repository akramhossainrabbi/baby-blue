    ...
    public function add_to_cart(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if ($product_info->type != 'single') {
                ...
                if ($product_info->sell_price_inc_tax > 0) {
                    // if($product_info->weighted == 1)
                    // {
                    //      $product_price = $product_info->sell_price_inc_tax * $product_info->product_weight;
                    // }
                    // else
                    // {
            ...
            foreach ($items as $id => $item) {
                $html .= '   <div class="add-pro-liner">
                                <div class="counting">
                                    ...
                                    <h3>' . $item->qty . '</h3>';
                if ($item->qty > 1) {
                    $html .= ' <a class="dec" data-row_id="' . $item->rowId . '" href="JavaScript:Void(0)"><i
            ...
            $html .= '<tr id="tr_' . $item->rowId . '" class="removeCartTrLi">
                            ...
                            <td class="qty">
                                ...
                                <div class="input-group">
                                    <span id="" class="input-group-btn dec"  data-row_id="' . $item->rowId . '"><i  class="btn btn-primary fa fa-minus" aria-hidden="true"></i></span>
                                        <input id="' . $item->rowId . '" class="input-sm form-control" name="qty" type="text" value="' . $item->qty . '">
                                   <span class="input-group-btn inc" data-row_id="' . $item->rowId . '" id=""><i  class="btn btn-primary fa fa-plus" aria-hidden="true"></i></span> 
                                </div>
                            </td>
                            <td class="price">
