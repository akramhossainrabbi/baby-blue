...
class TaxonomyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input['is_featured'] = $request->input('is_featured');
            $input['business_id'] = $request->session()->get('user.business_id');
            $input['created_by'] = $request->session()->get('user.id');
            $input['image'] =  !empty($request->input('image')) ? $request->input('image') : null;
            $input['fav_icon'] = !empty($request->input('fav_icon')) ? $request->input('fav_icon') : null;
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $category->image = !empty($request->input('image')) ? $request->input('image') : null;
                $category->fav_icon = !empty($request->input('fav_icon')) ? $request->input('fav_icon') : null;
