...
<section class="content content-custom no-print">
  <br>
	...
	<br>
	<div class="row row-custom mar-bot-20">
    	<div class="col-md-2 col-sm-6 col-xs-12 col-custom">
    ...
    @if(!empty($all_locations))
  	<!-- sales chart start -->
  		...
  		<div class="col-sm-6">
            @component('components.widget', ['class' => 'box-primary box-solid', 'title' => __('home.sells_last_30_days')])
    ...
    @if(!empty($all_locations))
  		...
  		<div class="col-sm-6">
            @component('components.widget', ['class' => 'box-primary box-solid', 'title' => __('home.sells_current_fy')])
    ...
    @endif
      ...
      <div class="col-sm-6">
        @component('components.widget', ['class' => 'box-warning box-solid'])
          @slot('icon')
