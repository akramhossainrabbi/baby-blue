  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/">
        ...
        <img src="{{ url( 'uploads/business_logos/' . Session::get('business.logo') ) }}" class="img-fluid">
        @endif
      </a>
    </div>
    <div id="navbar" class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        @if (Route::has('login'))
            @if(!Auth::check())
                <li><a class="btn btn-primary login-btn" href="{{ route('login') }}">@lang('lang_v1.login')</a></li>
