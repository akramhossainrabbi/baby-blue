...
{!! Form::open(['url' => action('ProductController@store'), 'method' => 'post', 
    'id' => 'product_add_form', 'enctype'=>'multipart/form-data','class' => 'product_form ' . $form_class, 'files' => true ]) !!}
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-sm-4">
            ...
            {!! Form::select('tags[]', $tags, !empty($duplicate_product->tags) ? $duplicate_product->tags : '', ['class' => 'form-control','multiple' => 'multiple', 'required']); !!}
        </div>
        <div class="clearfix"></div>
    ...
    ?>
        <div class="col-sm-4 ">
            <div class="form-group">
                ...
                {!! Form::select('discount_type', $discount_type, null, ['placeholder' =>
                __('messages.please_select'),'id' => 'discount_type', 'class' => 'form-control select2'],
                $tax_attributes); !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('discount_value', null, ['readonly' => 'readonly','id' => 'discount_value','class' =>
                'form-control readonly',
                'placeholder' => __('Discount Amount / Percentage')]); !!}
            </div>
        </div>
