...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('is_featured', ['1'=>'Yes','0'=>'No'], $product->is_featured,['class'=>'form-control',
                'required'=>'' ]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                'rows'=>'2','placeholder' => 'Long Description']) !!}
            </div>
        </div>
        <div class="col-sm-4">
            <?php
      ...
      ?>
            ...
            {!! Form::select('tags[]', $tags, $allTags,['class' => 'form-control','multiple' => 'multiple', 'required'])
            !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::textarea('seo_title', $product->seo_title,['class'=>'form-control', 'placeholder'=>'Write your
                seo title here', 'rows'=>4]) !!}
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::textarea('meta_key', $product->meta_key,['class'=>'form-control', 'placeholder'=>'Write your
                Meta keywords here', 'rows'=>4]) !!}
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                'placeholder'=>'Write your Meta Description here', 'rows'=>4]) !!}
            </div>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::select('unit_id', $units, $product->unit_id, ['placeholder' =>
                    __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
                    <span class="input-group-btn">
                        <button type="button" @if(!auth()->user()->can('unit.create')) disabled @endif class="btn
                            btn-default bg-white btn-flat quick_add_unit btn-modal"
        ...
        <div class="col-sm-4 @if(!session('business.enable_sub_units')) hide @endif">
            <div class="form-group">
                ...
                <select name="sub_unit_ids[]" class="form-control select2" multiple id="sub_unit_ids">
                    ...
                    <option value="{{$sub_unit_id}}" @if(is_array($product->sub_unit_ids) &&in_array($sub_unit_id,
                        $product->sub_unit_ids)) selected
                        @endif
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::select('warranty_id', $warranties, $product->warranty_id, ['class' => 'form-control select2',
    ...
    <div class="row">
        ...
        <div class="col-sm-4 @if($hide) hide @endif">
            <div class="form-group">
                <div class="multi-input">
                    ...
                    {!! Form::text('expiry_period', @num_format($product->expiry_period), ['class' => 'form-control
        ...
        <div class="col-sm-4">
            <div class="checkbox">
                <label>
                    {!! Form::checkbox('enable_sr_no', 1, $product->enable_sr_no, ['class' => 'input-icheck']); !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <br>
                <label>
                    {!! Form::checkbox('not_for_selling', 1, $product->not_for_selling, ['class' => 'input-icheck']);
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                @endif
                @else
                {!! Form::text('product_racks[' . $id . '][rack]', null, ['class' => 'form-control', 'id' => 'rack_' .
                $id, 'placeholder' => __('lang_v1.rack')]); !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                {!! Form::text('weight', $product->weight, ['class' => 'form-control', 'placeholder' =>
                __('lang_v1.weight')]); !!}
            </div>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('product_custom_field1', $product->product_custom_field1, ['class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('product_custom_field2', $product->product_custom_field2, ['class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('product_custom_field3', $product->product_custom_field3, ['class' => 'form-control',
        ...
        <div class="col-sm-3">
            <div class="form-group">
                ...
                {!! Form::text('product_custom_field4', $product->product_custom_field4, ['class' => 'form-control',
    ...
    $discount_type = array('1' => 'Percentage', '2' => 'Round', '3' => 'None');
    ?>
        <div class="col-sm-4 ">
            <div class="form-group">
                {!! Form::label('tax', __('Discount') . ':') !!}
                {!! Form::select('discount_type', $discount_type, $product->discount_type, ['id' =>
                'discount_type','placeholder' =>
                __('messages.please_select'),
                'class' => 'form-control select2'], $tax_attributes); !!}
            </div>
        </div>

        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('discount', __('Discount Value') . ':') !!}
                {!! Form::text('discount_value',$product->discount_value, ['id' => 'discount_value','class' =>
                'form-control',

                'placeholder' =>_('Discount Amount/Percentage')]); !!}
            </div>
        </div>
...
$(document).on('change', '#discount_type', function() {
    ...
    if (discount_type == 1) {
        ...
        $('#discount_value').prop('placeholder', '0%');
    } else if (discount_type == 2) {
        $('#discount_value').prop('readonly', false);
        $('#discount_value').prop('placeholder', '0.00');
    } else {
        $('#discount_value').prop('readonly', true);
        $('#discount_value').val('');
        $('#discount_value').prop('placeholder', 'None');
    }
});
