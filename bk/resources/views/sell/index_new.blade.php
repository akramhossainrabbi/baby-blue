...
$(document).ready( function(){
    ...
    var check =  "<?php echo auth()->user()->can('purchase_view')?>";
    sell_table = $('#sell_table').DataTable({
        processing: true,
        serverSide: true,
        aaSorting: [[1, 'desc']],
        "ajax": {
            "url": "/sells/report-purchase-sells",
            "data": function ( d ) {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            for (var r in data){
                ...
                footer_purchase_total += typeof($(data[r].final_purchase).data('orig-value')) != 'undefined' ? parseFloat($(data[r].final_purchase).data('orig-value')) : 0;
            }
            ...
            $('.footer_purchase_total').html(__currency_trans_from_en(footer_purchase_total));
