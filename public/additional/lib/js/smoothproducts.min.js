    ...
    a.fn.extend({
        smoothproducts: function() {
            ...
            a(".sp-loading").hide(), a(".sp-wrap").each(function() {
                ...
                if (b > 1) {
                    ...
                    a("a", this).each(function() {
                        var b = a("img", this).attr("src"),
                            c = a(this).attr("href");
                        a(this).parents(".sp-wrap").find(".sp-thumbs").append('<a href="" style="background-image:url(' + b + ')"></a>'),
                        a(this).remove()
                ...
                b.preventDefault(),
                        a(this).parent().find(".sp-current").removeClass(), a(this).addClass("sp-current"), a(this).parents(".sp-wrap").find(".sp-thumbs").removeClass("sp-tb-active"), a(this).parents(".sp-wrap").find(".sp-zoom").remove();
