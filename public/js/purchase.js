//add product from short stock
    ...
    $(document).on("click", "INPUT[id^=checkboxId_]", function (event) {
           ...
           var product_id = $(this).val();
            ...
            var str = targetId;
            var res = str.split("_");
            var product_variation = res[1];
            
             
           if ($("#" + targetId + ":checked").length > 0) {
              get_purchase_entry_row(product_id, product_variation);
           }
           else {
              alert('unchecked');
           }
...
$(document).ready(function() {
    ...
    var stock_alert_table = $('#stock_alert_table').DataTable({
        ...
        searching: false,
        dom: 'Btirp',
        ajax: '/home/product-stock-alert-purchase',
        ...
        $('#search_product')
            .autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    console.log(ui.item.variation_id);
    ...
    $(document).on('click', '.remove_purchase_entry_row', function() {
        ...
        // console.log($('.remove_purchase_entry_row').val());
