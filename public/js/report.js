$(document).ready(function() {
    ...
    product_sell_report = $('table#product_sell_report_table').DataTable({
        ...
        ajax: {
            ...
            data: function(d) {
                ...
                d.location_id = $('select#location_id').val();
                d.report_type = $('select#report_type').val();
            },
        },
        columns: [
            { data: 'product_name', name: 'p.name' },
    ...
    $(
        '#product_sell_report_form #variation_id, #product_sell_report_form #report_type, #product_sell_report_form #location_id, #product_sell_report_form #customer_id'
    ).change(function() {
    ...
    sell_payment_report = $('table#sell_payment_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'paid_on', name: 'paid_on' },
            { data: 'amount', name: 'transaction_payments.amount' },
            { data: 'final_purchase', name: 'final_purchase' },
        ...
        fnDrawCallback: function(oSettings) {
            ...
            var total_purchase_amount = sum_table_col($('#sell_payment_report_table'), 'final-purchase');
            $('#footer_total_amount').text(total_amount);
            $('#footer_total_purchase_amount').text(total_purchase_amount);
    ...
    product_report_table = $('#product_report_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            ...
            data: function(d) {
                ...
                d.supplier_id = $('select#ir_supplier_id').val();
                d.ir_product_id = $('select#ir_product_id').val();
                d.customer_id = $('select#ir_customer_id').val();
                d.location_id = $('select#ir_location_id').val();
            },
        },
        columns: [
            { data: 'product_name', name: 'p.name' },
            { data: 'sell_date', searchable: false},
            { data: 'report_type',  searchable: false },
            { data: 'product_name', name: 'p.name' },
            { data: 'product_name', name: 'p.name' },
