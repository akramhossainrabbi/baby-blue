                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="invoice-table-item"
                                     ...
                                     style="width: 100%; background: #f9fdff; padding: 15px 0 10px 15px">
                                                        ...
                                                        if(!empty($payment_details))
                                                        {
                                                            foreach ($payment_details as $key => $value) {
                                                                if ($key == 'card_number' || $key == 'card_type' || $key == 'pay_status' || $key == 'bank_txn') {
                                                                    ...
                                                                    $p_details = '<br><label style="font-weight: 700; color: #1d2d5d">' . ucfirst($key_field) . ': </label> <span>' . $value . '</span><br>';
                                                                }
                                            ...
                                            <div class="invoice-author-information">
                                                ...
                                                @if(!empty($orderUser))
                                                    ...
                                                    <p>
                                                        ...
                                                        <span style="font-weight: bold; color: #1d2d5d; font-family: 'Poppins'">Phone </span>:
                                        ...
                                        <div class="col-lg-4 col-lg-offset-2 hidden-xs col-sm-6">
                                            ...
                                            <div class="invoice-author-information1">
                                                ...
                                                <p>
                                                    ...
                                                    <label style="font-weight: 700; color: #1d2d5d">Invoice ID
                                    ...
                                    <div class="table-responsive hidden-xs">
                                        ...
                                        <table class="table table-bordered table-product-info " width="100%" border="0" cellpadding="0"
                                            ...
                                            <tr>
                                                ...
                                                <th style="font-size: 18px; text-align: center; text-transform: uppercase; line-height: 28px; font-weight: 500; background: #9c9c9b; color: #ffffff; text-align: center;">
                                            ...
                                            @foreach($order->detail as $detail)
                                                ...
                                                <tr style="border-bottom: 1px solid #dddddd;">
                                                    ...
                                                    <td style="width: 25%; vertical-align: middle;">
                                                        ...
                                                        <h4 style="font-size: 16px; font-weight: 600; color: #1d2d5d; line-height: 28px; margin-bottom: 0; text-align: center;">
                                                    ...
                                                    <td style="width: 13%; vertical-align: middle;">
                                                        ...
                                                        <p style="font-size: 18px; font-weight: 600; text-align: center; color: #1d2d5d; line-height: 28px; margin-bottom: 0;">
                                                    ...
                                                    <td style="width: 13%; vertical-align: middle;" >
                                                        ...
                                                        <p style="font-size: 18px; text-align: center; font-weight: 600; color: #1d2d5d; line-height: 28px; margin-bottom: 0;">
                                ...
                                <div class="total-amount-item row hidden-xs "
                                     ...
                                     style="background: #f9fdff; margin: 0px;">
