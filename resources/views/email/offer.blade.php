        ...
        <tr>
            <td align="left" valign="top">
                <table bgcolor="#f5f5f5"
                       style="background-image: url({!! asset('additional/images/offer-template-bg.jpg') !!});
                    ...
                    <tr>
                        <td align="center" valign="middle" style="padding-bottom: 20px;">
                            <img class="offer-img" src="{!! asset('additional/images/offer.png') !!}" alt="">
                        </td>
                    </tr>
                    <tr>
                        <td align="center" valign="middle">
                            <p style="background-image: url({!! asset('additional/images/parcen-offer-bg.png') !!});
                            background-repeat: no-repeat;
                            font-size: 14px;
                            font-weight: 500;
                            color: #ffffff;
                ...
                <table bgcolor="#f5f5f5"
                    ...
                    <tr>
                        <td align="left" valign="middle" style="padding-left: 20px;" class="column">
                            <img style="margin-right: 12px;" src="{!! asset('additional/images/icon.png') !!}" alt="">
                        ...
                        <td align="left" valign="middle" class="column">
                            <img style="margin-right: 12px;" src="{!! asset('additional/images/icon2.png') !!}" alt="">
                        ...
                        <td align="left" valign="middle" class="column">
                            <img style="margin-right: 12px;" src="{!! asset('additional/images/icon3.png') !!}" alt="">
                            <p style="display: inline-block; font-size: 16px; color: #1d2d5d; margin-bottom: 0; font-weight: 500;">
                                {{$address}}
                        ...
                        <td align="center" valign="middle">
                            @empty(!SM::smGetThemeOption("social_facebook"))
                                <a href="{{SM::smGetThemeOption("social_facebook")}}" style="padding: 0 7px; display: inline-block">
                                    <img src="{!! asset('additional/images/face-icon.png') !!}" alt="">
                                </a>
                            @endempty
                            ...
                            @empty(!SM::smGetThemeOption("social_youtube"))
                                <a href="{{SM::smGetThemeOption("social_youtube")}}" style="padding: 0 7px; display: inline-block">
                                    <img src="{!! asset('additional/images/youtube-icon.png') !!}" alt="">
                                </a>
                            @endempty
                        </td>
                    </tr>
