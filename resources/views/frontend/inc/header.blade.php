	...
	<section class="header-wrapper">
		...
		<div class="row">
				...
				<div class="col-md-6">
				    ...
				    <p class="text-right carabera" style="color: #fff;"><i class="fa fa-phone-square" area-hidden="true"></i>Hotline:&nbsp;01746-649336&nbsp;&nbsp;&nbsp; <i class="fa fa-envelope-square" area-hidden="true"></i>Email:&nbsp;sales@babyblueorpinkbird.com</p>
	...
	<section class="middle-top">
		<div class="row">
			<div class="col-md-4 col-sm-4 col-xs-12">
				...
				<div class="logo" style="width: 75px !important;height: 50px !important;">
					<a href="{{ url('/') }}">
						<!--<img class="img-responsive" alt="{{ SM::get_setting_value('site_name') }}" src="{{SM::sm_get_the_src(SM::get_setting_value('logo'))}}"/>-->
                        <!--<img class="img-responsive" alt="Baby Blue Or Pink Bird" src="{{SM::sm_get_the_src(SM::get_setting_value('logo'))}}"/>-->
                        <img class="img-responsive" alt="Baby Blue Or Pink Bird" src="uploads/business_logos/1670747585_Baby-Blue-Logo-01.png"/>
