            ...
            <td align="left" valign="top">
                ...
                <table width="100%" border="0" cellpadding="0" bgcolor="#f9fdff" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td align="left" valign="top" style="padding-bottom: 30px; padding-right: 0px;"
                            ...
                            <p class="text-left"
                               style="font-size: 16px; font-weight: 500; color: #1d2d5d; line-height: 18px; margin-left: -70px; text-align: center">
                                <span style="color: #1d2d5d; font-weight: 700; ">Invoice ID No</span> : {{ $orderId }}
                            </p>
                            <p class="text-left"
                    ...
                    <tr>
                        <td valign="top" class="column" align="left"
                            ...
                            <p style="font-size: 14px; color: #1d2d5d; margin-bottom: 0; font-weight: 500;"><span
                                ...
                                Words</span> : <span style="color: #f68c26;">{{ title_case(SM::sm_convert_number_to_words($order->grand_total)) }}
                                    BDT only.</span></p>
                            <p style="font-size: 14px; color: #1d2d5d; margin-bottom: 0; font-weight: 500;"><span
                        ...
                        <td valign="middle" class="column no-padding" align="left"
                            ...
                            @if($order->shipping_method_charge>0)
                                <p style="font-size: 16px; color: #1d2d5d; margin-bottom: 0; font-weight: 600; padding: 5px 30px 10px 27px;">
                                    Delivery Cost :<span
                                            style="text-align: right; float: right"> {{ SM::order_currency_price_value($order->id,$order->shipping_method_charge)}}</span>
                                </p>
                            @endif

                            <p style="font-size: 16px; color: #fff; margin-bottom: 0; font-weight: 600; padding: 7px 30px 12px 27px; background-image: url(<?php echo asset('additional/images/total-bar.png');?>);
                                    background-repeat: no-repeat;
                                    ">Total Amount<span
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr bgcolor="#1d2d5d">
                        ...
                        <td colspan="3" valign="middle" class="single-table-pert column"
