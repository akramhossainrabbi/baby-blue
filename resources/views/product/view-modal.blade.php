	    ...
	    <div class="modal-body">
      		<div class="row">
      			<div class="col-sm-9">
	      			...
	      			<div class="col-sm-4 invoice-col">
						<span><strong>Short Description:</strong>
						{{\Illuminate\Support\Str::limit($product->short_description,18)}}</span><br/>
						<span><strong>Long Description</strong>
						{{\Illuminate\Support\Str::limit($product->long_description,18)}}</span><br/>
						<span><strong>Slug</strong>
						{{\Illuminate\Support\Str::limit($product->slug,18)}}</span><br/>
						<span><strong>SEO Title</strong>
						{{\Illuminate\Support\Str::limit($product->seo_title,18)}}</span><br/>
						<span><strong>Meta Keywords</strong>
						{{\Illuminate\Support\Str::limit($product->meta_key,18)}}</span><br/>
						<span><strong>Meta Description</strong>
						{{\Illuminate\Support\Str::limit($product->meta_description,18)}}</span><br/>
