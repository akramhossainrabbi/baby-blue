        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
              {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'product_sell_report_form' ]) !!}
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        {!! Form::label('report_type', __('purchase.report_type').':') !!}
                        <div class="input-group">
                            <span class="input-group-addon">
                                <i class="fa fa-cart"></i>
                            </span>
                            {!! Form::select('report_type', array('offline'=> "Offline Sale","online" => "Ecommerce Sale"), null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
